...
@TopComponent.Description(
        preferredID = "ConfigurationPanel",
...
@ActionID(category = "Window", id = "de.yadrone.apps.controlcenter.plugins.configuration.ConfigurationPanel")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_ConfigurationPanelName",
        preferredID = "ConfigurationPanel"
)
@NbBundle.Messages({
    "CTL_ConfigurationPanelName=Configuration Panel",
    "CTL_ConfigurationPanel=Configuration Panel",
    "HINT_ConfigurationPanel=This is the Configuration Panel"
})
public class ConfigurationPanel extends TopComponent implements ICCPlugin {
