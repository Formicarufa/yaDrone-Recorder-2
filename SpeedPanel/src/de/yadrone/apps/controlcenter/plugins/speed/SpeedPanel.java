...
@ActionID(category = "Window", id = "de.yadrone.apps.controlcenter.plugins.speed.SpeedPanel")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_SpeedPanelName",
        preferredID = "SpeedPanel"
)
@NbBundle.Messages({
    "CTL_SpeedPanelName=Speed Panel",
    "CTL_SpeedPanel=Speed Panel",
    "HINT_SpeedPanel=This is the Speed Panel"
})
public class SpeedPanel extends TopComponent implements ICCPlugin {
