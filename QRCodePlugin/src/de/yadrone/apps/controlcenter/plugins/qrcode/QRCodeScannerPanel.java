...
@TopComponent.Description(
        preferredID = "QRCodeScannerPanel",
        iconBase = "de/yadrone/apps/controlcenter/plugins/altitude/iconmonstr-puzzle-1-16.png",
        persistenceType = TopComponent.PERSISTENCE_NEVER
)
@TopComponent.Registration(mode = "video_mode", openAtStartup = true)
@ActionID(category = "Window", id = "de.yadrone.apps.controlcenter.plugins.qrcode.QRCodeScannerPanel")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_QRCodeScannerPanelName",
        preferredID = "QRCodeScannerPanel"
)
@NbBundle.Messages({
    "CTL_QRCodeScannerPanelName=QRCode Scanner Panel",
    "CTL_QRCodeScannerPanel=QRCode Scanner Panel",
    "HINT_QRCodeScannerPanel=This is the QRCode Scanner Panel"
})
public class QRCodeScannerPanel extends TopComponent implements ICCPlugin {
